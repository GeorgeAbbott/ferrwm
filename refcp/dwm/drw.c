...
// AFAICT not necessary as Rust string utf8
static long
...
// -> Drw::resize(&mut self, w, h)
// not fully implemented due to unsafe calls into C 
void
...
// -> Drw::create_fontset() 
// This one is a bit iffy. What does the iteration and 
// assignment in return statement do?
// Also, where do I implement this? On Drw? On Fnt? On Drw, calling
// Fnt::new()? TODO figure out
Fnt*
...
// -> Fnt::drop(&mut self)
// I am pretty certain this should be impld on the Fnt.
void
...
// Putting this onto Drw::create_color for now.
